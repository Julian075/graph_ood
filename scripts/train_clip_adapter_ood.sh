#!/bin/bash
#SBATCH --job-name=clip_adapter_ood_train    # Name of your job
...
# Run CLIP adapter OOD training
echo "Starting CLIP adapter OOD training..."
python main.py \
    --mode train_clip_adapter_ood \
    --input_dir ${DATA_DIR} \
